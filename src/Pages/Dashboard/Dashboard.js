...
import { API_BASE, authHeaders, getUser } from "../../utils/api";
...
const Dashboard = () => {
  ...
  // Read user from storage (set during login)
  const user = getUser();
  ...
  return (
    <div className="dash-wrapper">
      ...
      <main className="dash-main">
        {/* ── Topbar: removed duplicate static avatar ── */}
        <header className="dash-topbar">
          ...
          <div className="topbar-right">
            ...
            {/* Only ONE avatar/dropdown — no static topbar-avatar div */}
            <AvatarDropdown />
          </div>
        </header>
        ...
        {loading ? (
          <div className="chart-card wide">
            <div className="chart-header">
              ...
              <p>Fetching your usage data, please wait.</p>
            </div>
          </div>
        ) : error ? (
          <div className="chart-card wide">
